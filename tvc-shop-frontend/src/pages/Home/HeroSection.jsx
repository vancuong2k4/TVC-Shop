          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4 max-w-4xl mx-auto mt-16">
            ...
            <div
              className={`transition-all duration-1000 delay-700 transform
                ${index === currentSlide ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}
            >
              <Link to="/shop" className="inline-block px-8 py-4 text-xs font-semibold tracking-[0.2em] uppercase bg-white text-black hover:bg-gray-200 hover:text-black transition-colors duration-300">
                Khám phá ngay
              </Link>
            </div>
          </div>
